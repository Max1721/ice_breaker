...
def ice_break(name: str) -> PersonIntel:
    ...
    summary_template = """
        given the linkedin information {linkedin_information} and twitter {twitter_information} from a person I want you to create: 
        1. a short summary
...
if __name__ == "__main__":
    print("Hello Langchain!")  # This is a comment
